...
require "trail_accessibility/version"

Gem::Specification.new do |spec|
  spec.name          = "trail_accessibility"
  spec.version       = TrailAccessibility::VERSION
  spec.authors       = ["'Allison _'"]
  spec.email         = ["'allimacq@gmail.com'"]
